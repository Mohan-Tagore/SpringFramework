...
import com.tagore.springdemo.domain.test.OrganizationRegistration;
import com.tagore.springdemo.service.test.OrganizationRegistrationService;
...
public class FormTagsController {
	...
	public String organizationRegistration(@ModelAttribute OrganizationRegistration orgRegistration, Model model) {
		...
		return "test/formTagsTestViews/formTagsResults";
	}
