package com.tagore.springdemo.config;
...
import com.tagore.springdemo.interceptors.ExecutionTimerInterceptor;
import com.tagore.springdemo.interceptors.HeaderInterceptor;
import com.tagore.springdemo.interceptors.VisitorInterceptor;

@Configuration
@ComponentScan("com.tagore.springdemo")
@EnableWebMvc
public class WebMvcConfig extends WebMvcConfigurerAdapter {
	...
	public DataSource dataSource() {
		...
		// for false value-->java:comp/env/jdbc/springdb
