package com.tagore.springdemo.interceptors;
...
public class ExecutionTimerInterceptor implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		LOGGER.info("Info Message: PREHANDLE TIME = " + PREHANDLE_TIME);
		return true;
	}
	...
	public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler,
		...
		LOGGER.info("Info Message: POSTHANDLE TIME = " + POSTHANDLE_TIME);
	...
	public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex)
		...
		LOGGER.info("Info Message: AFTER COMPLETION TIME = " + AFTER_COMPLETION_TIME);
		long HANDLER_EXECUTION_TIME = POSTHANDLE_TIME - PREHANDLE_TIME;
		long TOTAL_EXECUTION_TIME = AFTER_COMPLETION_TIME - PREHANDLE_TIME;
		LOGGER.info("Info Message: HANDLER EXECUTION TIME = " + HANDLER_EXECUTION_TIME);
		LOGGER.info("Info Message: TOTAL EXECUTION TIME = " + TOTAL_EXECUTION_TIME);
	}
